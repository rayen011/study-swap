...
class AppColors {
  ...
  static const Color lightBlueActive = Color(0xFFE2E8F0); // Active tab background
  static const Color limeGreen = Color(0xFFCAFF00); // The "NEXT" and "Get Started" buttons
